...
/// Render an inline icon for the named Feather icon used by the site.
pub fn feather_icon(name: String) -> Element(msg) {
  svg.svg(feather_attributes(), [feather_shape(name)])
}

fn feather_attributes() -> List(attribute.Attribute(msg)) {
  [
    attribute.attribute("viewBox", "0 0 24 24"),
    attribute.width(20),
    attribute.height(20),
...
fn feather_shape(name: String) -> Element(msg) {
  case name {
    "sun" ->
      svg.g([], [
        svg.circle([
    ...
    "linkedin" ->
      svg.g([], [
        ...
        svg.path([
          attribute.attribute("d", "M16 16v-3a2 2 0 0 0-4 0"),
        ]),
      ])
    "rss" ->
      svg.g([], [
        svg.path([
          attribute.attribute("d", "M4 11a9 9 0 0 1 9 9"),
        ]),
        svg.path([
          attribute.attribute("d", "M4 4a16 16 0 0 1 16 16"),
        ]),
        svg.circle([
